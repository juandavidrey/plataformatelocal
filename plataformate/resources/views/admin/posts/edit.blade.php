        ...
        <div class="box-body">
          <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('resumen') ? 'has-error': '' }}">
              ...
              <textarea name="resumen" rows="10" class="form-control" placeholder="Ingresa las Actividades">{{ old('resumen', $post->resumen) }}</textarea>
            ...
            <div class="form-group {{ $errors->has('objetivos') ? 'has-error': '' }}">
              ...
              <textarea name="objetivos" rows="10" class="form-control" placeholder="Ingresa los objetivos de la organización">{{ old('objetivos', $post->objetivos) }}</textarea>
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <div class="form-group {{ $errors->has('rol_contacto') ? 'has-error': '' }}">
            ...
            <textarea name="rol_contacto" class="form-control" placeholder="Rol del contacto en la organización">{{ old('rol_contacto', $post->rol_contacto) }}</textarea>
