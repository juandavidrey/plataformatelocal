...
//            'menu_position' => 4,
    ...
    static function getMarkupBoxShow() {
    	return get_option(CMA_AnswerController::OPTION_MARKUP_BOX_SHOW, 0);
    }
    
    
    static function showLoginForm() {
    	return get_option(static::OPTION_SHOW_LOGIN_FORM, 1);
    }
    
    static function setShowLoginForm($val) {
    	return update_option(static::OPTION_SHOW_LOGIN_FORM, $val, true);
    }
...
";
    ...
    {
        return (bool) get_option(self::OPTION_QUESTION_AUTO_APPROVE, 1);
    }

    public static function isAnswerAutoApproved()
    {
        return (bool) get_option(self::OPTION_ANSWER_AUTO_APPROVE, 1);
    }
