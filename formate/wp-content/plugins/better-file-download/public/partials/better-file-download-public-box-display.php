<div class="bfd-single-download" id="bfd-single-download-<?php echo intval( $bfd_args['id'] ) ?>">
	...
	<div class="bfd-single-row">
		...
		<?php
		 ...
		 $bfd_title = ( $bfd_args['title'] ) ? $bfd_args['title'] : __('Descargar ') . $bfd_download->post_title;
		 ...
		 if( ! empty( $bfd_options['bfd_times_textfield'] ) && ! empty( $bfd_options['bfd_time_textfield'] ) )
 			{
 				$bfd_plural =  _n( $bfd_options['bfd_time_textfield'] , $bfd_options['bfd_times_textfield'] , $bfd_count, $this->plugin_name );
 			}
 			else
 			{
		 ...
		 <div class="bfd-column">
		 	<a href="<?php echo get_permalink( $bfd_args['id'] ); ?>" title="<?php echo esc_attr( $bfd_title ); ?>" class="bfd-download-meta" <?php echo (! empty( $bfd_options['bfd-force-new-tab'] ) ? 'target="_blank"' : 'download' )  ?> >
