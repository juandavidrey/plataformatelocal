    ...
    $( document ).ready(function() {
        ...
        function ThemeChange(object,first){
            ...
            if (object.val().indexOf("masonry") > -1) {
                ...
                $("#wplp_config_zone,#wplp_config_zone_new, #wplp_config_animation,#wplp_arrows_color,#wplp_readmore_config,#wplp_overlay_default_config").addClass("disabled");
                $("#wplp_config_color,#colorPicker .color,#wplp_config_cropText").removeClass("disabled");


                $('#wplp_config_animation input,#wplp_config_animation select,#amount_pages,#pagination,#amount_rows,#defaultColorTheme,#readmore_size').attr('disabled','disabled');
                ...
                $('li.field.lazyloadConfig').addClass("disabled");
                $('.lazyloadConfig input,input#overlayIcon,#overlayTransparent').attr('disabled','disabled');
                ...
                $('#colorPicker').show();
                $('#arrowColor,#arrowHoverColor,#readmoreBgColor,#readmoreTextColor,#overlayColor,#overIconColor,#overBGIconColor').hide();
                ...
                $("#wplp_config_zone, #wplp_config_zone_new,#wplp_arrows_color,#wplp_readmore_config,#wplp_overlay_default_config").addClass("disabled");
                ...
                $('.loadmore,li.field.lazyloadConfig').addClass("disabled");
                $('.loadmore input,#readmore_size,input#overlayIcon').attr('disabled','disabled');
                
                $('.forceicon').addClass("disabled");
                $('.forceicon input,.lazyloadConfig input,#overlayTransparent').attr('disabled','disabled');
                $('.on_icon_selector,#overlayColor,#overIconColor,#overBGIconColor').hide();
                $('#dfThumbnail, #dfTitle, #dfAuthor, #dfDate, #dfCategory, #dfText, #dfReadMore').click(function(){
                    return false;
                });
                $('.imagePosition .select-dropdown').prop('disabled',true);
                ...
                //$('ul.arrow_col, .drop_zone_col .wpcu-inner-admin-block ul').sortable( "disable" );
                $('#colorPicker').show();
                $('#arrowColor,#arrowHoverColor,#readmoreBgColor,#readmoreTextColor').hide();
            }
                ...
                //$('ul.arrow_col, .drop_zone_col .wpcu-inner-admin-block ul').sortable( "disable" );
                $('.loadmore,li.field.lazyloadConfig').addClass("disabled");
                $('.loadmore input,#readmore_size,#overlayTransparent').attr('disabled','disabled');
                
                $('.forceicon').addClass("disabled");
                $('.forceicon input,.lazyloadConfig input,input#overlayIcon').attr('disabled','disabled');
                $('.on_icon_selector').hide();
                $('#dfThumbnail, #dfTitle, #dfAuthor, #dfDate, #dfCategory, #dfText, #dfReadMore').click(function(){
                    return false;
                });
...
//            <!-- theme portfolio -->
                ...
                $("#wplp_config_cropText,#wplp_arrows_color,#wplp_readmore_config,#wplp_overlay_default_config").addClass("disabled");
                ...
                //$('ul.arrow_col, .drop_zone_col .wpcu-inner-admin-block ul').sortable("disable");
                $('.loadmore,li.field.lazyloadConfig').addClass("disabled");
                $('.loadmore input,#readmore_size,.lazyloadConfig input,input#overlayIcon').attr('disabled','disabled');
                
                $('.forceicon').addClass("disabled");
                $('.forceicon input,#overlayTransparent').attr('disabled','disabled');
                $('.on_icon_selector').hide();
                $('#dfThumbnail, #dfTitle, #dfAuthor, #dfDate, #dfCategory, #dfText, #dfReadMore').click(function(){
                    return false;
                });
                ...
                $("#wplp_config_zone_new,#wplp_config_animation, #wplp_config_cropText,#pagination,#wplp_arrows_color,#wplp_readmore_config,#wplp_overlay_default_config").removeClass("disabled");
                ...
                $('li.field.lazyloadConfig').removeClass("disabled");
                $('.lazyloadConfig input,input#overlayIcon,#overlayTransparent').removeAttr('disabled');
                ...
                $('.imagePosition .select-dropdown,#readmore_size').prop('disabled',false);
                ...
                $('#colorPicker').hide();
                $('#arrowColor,#arrowHoverColor,#readmoreBgColor,#readmoreTextColor,#overlayColor,#overIconColor,#overBGIconColor').show();
                // if ($("ul.arrow_col").hasClass("ui-sortable"))
                //$('ul.arrow_col, .drop_zone_col .wpcu-inner-admin-block ul').sortable( "disable" );
            }
            ...
            if (object.val().indexOf("masonry-category") > -1) {
                $("#wplp_config_cropText,#wplp_arrows_color,#wplp_readmore_config,#wplp_overlay_default_config").addClass("disabled");
                $('#wplp_config_cropText input,#readmore_size,.lazyloadConfig input,input#overlayIcon,#overlayTransparent').attr('disabled','disabled');
                $('#arrowColor,#arrowHoverColor,#readmoreBgColor,#readmoreTextColor,#overlayColor,#overIconColor,#overBGIconColor').hide();
                $('li.field.lazyloadConfig').addClass("disabled");
            }
