				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Standart Without Button'){ ?>
					<style type="text/css">
						...
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php }?>
							/*border-top-left-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_BR-2;?>px;*/
							/*border-bottom-left-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_BR-2;?>px;*/
					...
					<form method="POST" onsubmit="">
						<div class="Total_Soft_Poll_Main_Div">
							<div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>">
								...
								<div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?>">
									<?php for($i = 0 ; $i < $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; $i++){ ?>
										<div class="Total_Soft_Poll_1_Ans_Check_Div" style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_CA == 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; }?>">
											...
											<label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll;?> totalsoft totalsoft-question-circle-o" for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll;?>_<?php echo $i+1;?>" style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_CA == 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php }?>" onclick="Total_Soft_Poll_3_Vote(<?php echo $Total_Soft_Poll;?>, <?php echo $Total_Soft_Poll_Ans[$i]->id;?>)"><?php echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans);?></label>
				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Image Without Button' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video Without Button'){ ?>
					<style type="text/css">
						...
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php }?>
							/*border-top-left-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_BR-2;?>px;*/
							/*border-bottom-left-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_BR-2;?>px;*/
								...
								<div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?>">
									<?php for($i = 0 ; $i < $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; $i++){
										...
										<div class="Total_Soft_Poll_1_Ans_Check_Div" style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_CA == 'Background'){ ?>background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; }?>">
											...
											<div class="Total_Soft_Poll_1_Ans_Check_Div2 Total_Soft_Poll_1_Ans_Check_Div2_<?php echo $Total_Soft_Poll;?>" onclick="Total_Soft_Poll_4_Vote(<?php echo $Total_Soft_Poll;?>, <?php echo $Total_Soft_Poll_Ans[$i]->id;?>)">
				...
				<?php } else if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Image in Question' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video in Question'){ ?>
					<style type="text/css">
						...
						.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll;?>
						{
							...
							<?php }?>
							/*border-top-left-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_BR-2;?>px;*/
							/*border-bottom-left-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_BR-2;?>px;*/
							...
							<div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>">
								...
								<div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll;?>">
									...
									<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_Show == 'true'){ ?>
										<button class="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll;?>" id="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll;?>" name="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll;?>" type="button" value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_VB_Text);?>" onclick="Total_Soft_Poll_5_Vote(<?php echo $Total_Soft_Poll;?>)">
											<i class="totalsoft Total_Soft_Poll_1_Vote_But_Icon">
