...
abstract class CMA_BaseController
{
    ...
    const PAGE_ABOUT_URL = 'https://www.cminds.com/store/?showfilter=No&cat=Plugin&nitems=3';
    const PAGE_ADDONS_URL = 'https://www.cminds.com/store/?showfilter=No&amp;tags=Answer&amp;nitems=3';
    const PAGE_USER_GUIDE_URL = 'https://www.cminds.com/wordpress-plugins-knowledge-base-and-documentation/?hscat=987-answers-cma';
...
//                }
    ...
    public static function registerAdminPages()
    {
        ...
        if (current_user_can('manage_options')) {
//         	$submenu[apply_filters('CMA_admin_parent_menu', 'options-general.php')][400] = array('About', 'manage_options', self::PAGE_ABOUT_URL);
//         	$submenu[apply_filters('CMA_admin_parent_menu', 'options-general.php')][401] = array('Add-ons', 'manage_options', self::PAGE_ADDONS_URL);
        }
...
//             $submenu[apply_filters('CMA_admin_parent_menu', 'options-general.php')][500] = array('User Guide', 'manage_options', self::PAGE_USER_GUIDE_URL);
        }
        
        if (current_user_can('manage_options')) {
//         	$submenu[apply_filters('CMA_admin_parent_menu', 'options-general.php')][999] = array('Yearly membership offer', 'manage_options', self::PAGE_YEARLY_OFFER);
