(function( $ ) {
	...
	$(document).ready(function (){
		...
		if( jQuery( 'body' ).hasClass( 'wp-customizer' ) ) {
			...
			$( '#customize-header-actions' ).after( '<div id="customize-thinkup-upgrade" class=""><p><a href="https://www.thinkupthemes.com/themes/melos/" target="_blank" class="promotion-button" style="">Upgrade Now</a></p></div>' );
