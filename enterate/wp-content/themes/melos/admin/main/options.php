...
//			),
    ...
    Redux::setSection( $opt_name, array(
		'title'      => __('Support', 'melos'),
		'desc'       => __('For premium support direct from the theme developers, or advice on customizations please <a href="https://www.thinkupthemes.com/themes/melos/" target="_blank">upgrade</a> to Melos Pro or purchase a <a href="http://www.thinkupthemes.com/pricing/" target="_blank">Theme Subscription</a>.', 'melos'),
		'icon'       => 'el el-user',
		'icon_class' => '',
