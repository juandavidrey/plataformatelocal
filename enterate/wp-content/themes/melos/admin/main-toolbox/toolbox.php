...
function melos_thinkup_toolbox_setup() {    
	...
	*/
	...
	$config = array(
		...
		'menu_name'             => sprintf( __( 'About %1$s (Free)', 'melos' ), ucfirst( $theme_name ) ),
		// Page title.
		'page_name'             => sprintf( __( 'About %1$s (Free)', 'melos' ), ucfirst( $theme_name ) ),
		// Main welcome title
		'welcome_title'         => sprintf( __( 'Welcome to %1$s! - v', 'melos' ), ucfirst( $theme_name ) ),
		...
		'upgrade'             => array(
			...
			'price_discount'  => __( 'Upgrade for $31 (10% off)', 'melos' ),
			'price_normal'	  => __( 'Normally $35. Use coupon at checkout.', 'melos' ),
			'coupon'	      => $theme_name . '31',
			'button'	      => __( 'Upgrade Now', 'melos' ),
		),
		'tabs'                 => array(
			'getting_started'  => __( 'Getting Started', 'melos' ),
			'documentation'    => __( 'Documentation', 'melos' ),
			'support_content'  => __( 'Support', 'melos' ),
			'free_pro'         => __( 'Free VS PRO', 'melos' ),
		),
		// Getting started tab
		...
		'free_pro'                => array(
			...
			'features'            => array(
				array(
					'title'            => __( 'Mobile Friendly', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'true',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Background Image', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'true',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Fontpage Sections', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'true',
					'is_in_lite_text'  => '3',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Fontpage Slides', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'true',
					'is_in_lite_text'  => '3',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Built-In Social Buttons', 'melos' ),
					'description'      => '',
					'is_in_lite'       => '',
					'is_in_lite_text'  => '7',
					'is_in_pro'        => '',
				...
				array(
					'title'            => __( 'Advanced Theme Options', 'melos' ),
					'description'      => '',
					'is_in_lite'       => '',
				...
				array(
					'title'            => __( 'Theme Options Panel', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Unlimited Color Options', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( '600+ Google Fonts', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Unlimited Sliders', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Google Map Section', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Parallax Effects', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Animation Effects', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Extended Layout Options', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'Premium Support', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
				...
				array(
					'title'            => __( 'No credit footer link', 'melos' ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
	...
	melos_thinkup_toolbox_about_page::init( $config );

}

add_action('after_setup_theme', 'melos_thinkup_toolbox_setup');
